...
fn write_header(f: &mut fs::File) -> Result<()> {
    writeln!(f, "// This Source Code Form is subject to the terms of the Mozilla Public")?;
    writeln!(f, "// License, v. 2.0. If a copy of the MPL was not distributed with this")?;
    writeln!(f, "// file, You can obtain one at http://mozilla.org/MPL/2.0/.\n")?;
